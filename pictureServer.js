...
io.on('connect', function(socket) {
  ...
  socket.on('takePicture', function() {
    ...
    console.log('Just took a picture '+ imageName);
        
      
    //setTimeout(function(){ console.log('Counting seconds...'); }, 3000);
    
    im.resize({
      srcPath: 'public/'+imageName+'.jpg',
      dstPath: 'public/'+imageName+'-small.jpg',
      width:   200
    }, function(err, stdout, stderr){
      if (err) throw err;
      console.log('resized Image to fit within 200 wide');
    });

    setTimeout(function(){ console.log('Counting seconds...'); }, 3000);

    io.emit('newPicture',(imageName+'-small.jpg')); ///Lastly, the new name is send to the client web browser.
    /// The browser will take this new name and load the picture from the public folder.
    console.log('Just emitted Thumbnail the ' + imageName+'-small.jpg');
